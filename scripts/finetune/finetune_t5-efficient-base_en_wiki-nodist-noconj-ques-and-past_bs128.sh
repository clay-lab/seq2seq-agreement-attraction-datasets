...
#SBATCH --job-name=t5-efficient-base-base-finetune-tense-en_wiki-nodist-noconj-ques-and-past
...
python core/run_seq2seq.py \
	...
	--output_dir outputs/t5-efficient-base-finetuning-en_wiki-nodist-noconj-ques-and-past-bs128/ \
