...
#SBATCH --job-name=t5-efficient-small-base-finetune-tense-en_wiki-nodist-ques-and-past
...
python core/run_seq2seq.py \
	...
	--output_dir outputs/t5-efficient-small-finetuning-en_wiki-nodist-ques-and-past-bs128/ \
