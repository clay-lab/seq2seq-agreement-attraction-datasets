...
#SBATCH --job-name=t5-small-base-eval-tense-en_wiki-nodist-noconj-ques-and-past
...
python core/run_seq2seq.py \
	...
	--output_dir outputs/t5-small-finetuning-en_wiki-nodist-noconj-ques-and-past-bs128/ \
